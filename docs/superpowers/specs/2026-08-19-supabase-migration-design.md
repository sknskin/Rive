...
날짜: 2026-08-19
상태: **역사적 설계 — 핵심 구현 완료, 운영 세션 RPC migration만 미적용 (2026-08-20 확인)**
근거: 6차 전수조사 체크리스트(docs/BACKLOG.md P1-3, B1~B4), 현행 코드 실측. 스펙 §70~77 원문은
리포에 없어 BACKLOG 2차 서술 기준 — 원문 수령 시 본 문서에 반영.

> 이후 구현에서 이메일 인증뿐 아니라 Google OAuth, Realtime, AI quota, 서버 원자 import,
> 원자 독서 세션 RPC까지 확장됐다. 현행 상태와 다음 작업은
> [`../../HANDOFF.md`](../../HANDOFF.md), 최신 잔여는
> [`../../BACKLOG.md`](../../BACKLOG.md) 최하단을 기준으로 한다. 이 문서의 “승인 필요”와
> “후속” 표기는 2026-08-19 설계 당시 기록이다.
